...
- **VHS-bevegelse:** Coveret hengsler fra venstre kant. Selve lederkassetten trekkes 34 % ut av etuiet og legges over nabokortene, mens øvrige kassetter forblir helt inne; skall og kassett er ellers skalert inn i samme fysiske system.
- **Video:** YouTube-traileren autospiller dempet med `controls=0`, tastatur og pekerinteraksjon avskåret. Den lastes bak en svart TV og holdes skjult bak skurring i fire sekunder etter bekreftet avspilling, slik at oppstartsoverlegget rekker å forsvinne. Hvis mobilnettleseren blokkerer autoplay, vises filmplakaten i stedet for at skurringen blir stående. Skurringen bruker et bilde uten native videokontroller, og videoen fyller CRT-flaten uten letterbox-felt.
